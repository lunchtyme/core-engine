...
exports.getEmployeesLunchTime2hoursFromNowQuery = void 0;
const moment_timezone_1 = __importDefault(require("moment-timezone"));
const getEmployeesLunchTime2hoursFromNowQuery = () => {
    ...
    const startUtc = moment_timezone_1.default.utc(targetUtc).subtract(bufferMinutes, 'minutes').toDate();
    const endUtc = moment_timezone_1.default.utc(targetUtc).add(bufferMinutes, 'minutes').toDate();
...
exports.getEmployeesLunchTime2hoursFromNowQuery = getEmployeesLunchTime2hoursFromNowQuery;
