...
import { addMealSuggestionController, getMealSuggestionsController } from '../controllers';
...
mealSuggestionRouter.post('/suggest', resolveAuthContext, addMealSuggestionController);
...
mealSuggestionRouter.get('/suggestions', resolveAuthContext, getMealSuggestionsController);
